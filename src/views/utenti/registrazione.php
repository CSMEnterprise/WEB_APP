...
<div style="text-align: center; margin-bottom: 40px; margin-top: 20px;">
    ...
    <p class="muted" style="font-size: 16px;">Entra in NerdVault con il profilo più adatto alle tue esigenze.</p>
</div>
...
<div class="grid-2" style="max-width: 900px; margin: 0 auto;">
    ...
    <article class="card" style="display: flex; flex-direction: column; justify-content: space-between; border: 2px solid var(--gold); position: relative;">
        ...
        <div>
            ...
            <p style="color: var(--muted); margin-bottom: 24px; line-height: 1.5;">Pensato per negozi, rivenditori e attività che vogliono gestire la propria presenza professionale sul marketplace.</p>
            <ul style="list-style: none; padding: 0; margin: 0 0 32px 0;">
                ...
                <li style="margin-bottom: 12px; display: flex; align-items: center; gap: 8px;"><span style="color: var(--gold);">✔</span> Storico ordini e fatturazione</li>
                <li style="margin-bottom: 12px; display: flex; align-items: center; gap: 8px;"><span style="color: var(--gold);">✔</span> Pagina venditore in evidenza</li>
            </ul>
        </div>
...
<div style="text-align: center; margin-top: 32px; padding-bottom: 40px;">
    <p>Hai già un account? <a href="index.php?route=login" style="color: var(--accent); font-weight: 600;">Accedi qui</a></p>
</div>
